...
const paymentMethods = ['BCA', 'Mandiri', 'BNI', 'BRI', 'OVO', 'DANA', 'GoPay', 'ShopeePay']
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-10 md:grid-cols-2 md:px-6 lg:grid-cols-5 lg:py-12">
        <div>
          ...
          <p className="mt-5 max-w-xs text-sm leading-6 text-zinc-600">
            Thank you for trusting us. We’re here to provide the best products and experience for you.
          </p>

          <div className="mt-6 flex items-center gap-4">
            <Link href="https://instagram.com" aria-label="Instagram" className="hover:opacity-60">
              <InstagramIcon className="h-5 w-5" />
            </Link>
            <Link href="https://tiktok.com" aria-label="TikTok" className="hover:opacity-60">
              <TikTokIcon className="h-5 w-5" />
            </Link>
            <Link href="https://wa.me/6281234567890" aria-label="WhatsApp" className="hover:opacity-60">
              <MessageCircle className="h-5 w-5" />
            </Link>
            <Link href="mailto:hello@example.com" aria-label="Email" className="hover:opacity-60">
              <Mail className="h-5 w-5" />
            </Link>
          </div>
        </div>

        <FooterLinkColumn title="Customer Service" links={customerServiceLinks} />
        <FooterLinkColumn title="Information" links={informationLinks} />

        <div>
          <h3 className="text-xs font-bold uppercase tracking-wide">Contact Us</h3>
        ...
        <div>
          <h3 className="text-xs font-bold uppercase tracking-wide">Payment Method</h3>
...
function BrandLogo() {
  return (
    <div>
      <div className="text-lg font-bold uppercase tracking-[0.35em] md:text-xl">Storefront</div>
      <div className="mt-1 text-[9px] font-medium uppercase tracking-[0.45em] text-zinc-500">Official Store</div>
    </div>
  )
}
