    ...
    >
      ...
      <div className="relative z-10 flex flex-col bg-white p-4">
        <div className="flex flex-col gap-1">
          <h3 className="text-sm font-black uppercase tracking-tight text-zinc-900 transition-colors group-hover:text-black">{product.name}</h3>
          <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">{product.colorway}</p>
          <p className="mt-2 text-sm font-black tracking-tight text-zinc-900">{product.price}</p>
        </div>
