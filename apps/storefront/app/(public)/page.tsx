...
export default async function HomePage() {
  ...
  return (
    <>
      <section className="relative w-full h-[600px] md:h-[650px] lg:h-[700px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 md:px-6 text-white">
          <div className="max-w-xl">
            <p className="mb-6 text-xs font-semibold uppercase tracking-[0.3em] text-zinc-400 opacity-0 animate-fade-in-up">
              Premium Sneakers
            </p>

            <h1 className="text-5xl font-black uppercase leading-[0.95] tracking-tight md:text-6xl lg:text-7xl text-white opacity-0 animate-fade-in-up" style={{ animationDelay: "150ms" }}>
              Shoeting<br />
            ...
            <p className="mt-6 max-w-sm text-base leading-7 text-zinc-300 opacity-0 animate-fade-in-up" style={{ animationDelay: "300ms" }}>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-2 px-4 py-4 md:grid-cols-4 md:px-6">
          {trustItems.map((item, index) => {
            ...
            return (
              ...
              >
                <Icon className="h-8 w-8 shrink-0 stroke-[1.5] transition-transform duration-300 hover:scale-110 hover:rotate-3 text-zinc-800" />
                <div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-5">
          {displayedCategories.map((category, index) => (
            ...
            >
              ...
              >
                <div className="aspect-square rounded-md bg-gradient-to-br from-zinc-100 to-zinc-200 flex items-center justify-center border border-zinc-200 shadow-sm transition-all duration-300 group-hover:scale-[1.02] group-hover:border-black group-hover:shadow-md">
                  <span className="text-4xl font-black text-zinc-300 uppercase tracking-widest select-none transition-transform duration-300 group-hover:scale-110">
      ...
      <section className="mx-auto grid max-w-7xl px-4 py-10 md:grid-cols-2 md:px-6 lg:py-14 gap-0 overflow-hidden">
        <ScrollReveal direction="left" distance={40} duration={1000} className="w-full">
          <div className="min-h-56 h-full rounded-t-md bg-gradient-to-br from-zinc-100 to-zinc-200 md:rounded-l-md md:rounded-tr-none" />
        </ScrollReveal>

        <ScrollReveal direction="right" distance={40} delay={150} duration={1000} className="w-full">
          <div className="flex min-h-56 h-full flex-col justify-center rounded-b-md bg-zinc-50 p-7 md:rounded-r-md md:rounded-bl-none lg:p-10">
            ...
            <Button className="mt-6 w-fit rounded-none bg-black px-7 text-xs font-semibold uppercase tracking-wide text-white transition-all duration-300 hover:bg-zinc-800 hover:shadow-[0_0_15px_rgba(0,0,0,0.15)]">
              Join via WhatsApp
            </Button>
          </div>
        </ScrollReveal>
