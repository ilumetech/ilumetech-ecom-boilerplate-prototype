      ...
      <div className="relative hidden w-full md:flex md:w-1/2 bg-zinc-900 flex-col justify-end p-12 text-white min-h-screen">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-xs font-bold uppercase tracking-widest text-zinc-300 max-w-sm leading-relaxed">
            Sign in to access your orders, track shipments, and manage your wishlist.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center md:text-left mb-8">
            ...
            <p className="mt-2 text-xs font-bold uppercase tracking-widest text-zinc-500">
              Access your storefront customer account
            </p>
          </div>
          ...
          <div className="flex justify-center md:justify-start w-full">
            <SignIn
              ...
              appearance={{
                ...
                elements: {
                  rootBox: "w-full flex justify-center md:justify-start",
                  ...
                  socialButtonsBlockButton: "!border !border-zinc-200 hover:!border-black !rounded-none transition-all text-[10px] font-bold uppercase tracking-widest h-12 !shadow-none",
                  ...
                  formInput: "h-12 !rounded-none !border !border-zinc-200 focus-visible:!ring-0 focus-visible:!border-black text-xs font-bold uppercase tracking-widest px-4",
                  formButtonPrimary: "h-12 !rounded-none !bg-black text-[10px] font-bold uppercase tracking-widest hover:!bg-zinc-800 transition-all !shadow-none !border-none",
