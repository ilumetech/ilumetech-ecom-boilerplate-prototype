...
const sections = [
  {
    ...
    icon: Eye,
    content: 'We collect information you provide directly to us when you create an account, make a purchase, or communicate with us. This may include your name, email address, phone number, shipping address, and payment information.'
  },
  {
    title: 'How We Use Data',
    icon: FileText,
    content: 'Your data is primarily used to process orders, manage your account, and provide customer support. We also use information to improve our services, send marketing communications (with your consent), and prevent fraudulent transactions.'
  },
  {
    title: 'Data Security',
    icon: Shield,
    content: 'We implement industry-standard security measures to protect your personal information. All transactions are processed through secure gateways, and we do not store sensitive payment details on our servers.'
  },
  {
    title: 'Information Sharing',
    icon: Lock,
    content: 'We do not sell your personal data. We only share information with trusted third-party service providers (like shipping couriers and payment processors) necessary to fulfill your orders and operate our business.'
  },
  {
    title: 'Your Rights',
    icon: UserCheck,
    content: 'You have the right to access, update, or delete your personal information at any time. You can also opt-out of marketing communications by following the unsubscribe instructions in our emails.'
  },
  {
      ...
      <section className="mx-auto max-w-7xl px-4 py-6 md:px-6 lg:py-10">
        ...
        <div className="max-w-4xl">
          ...
          <p className="mt-8 text-lg leading-8 text-zinc-600 md:text-xl">
            At Storefront, we take your privacy seriously. This policy explains how we collect, use, and protect your personal information when you shop with us.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-zinc-600">
              If you have any questions or concerns about how we handle your data, please don't hesitate to reach out to our legal team or customer support.
            </p>
