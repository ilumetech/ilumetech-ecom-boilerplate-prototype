...
import { Package, Search, MessageCircle, Truck, CheckCircle2, Clock, MapPin } from 'lucide-react'
        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:gap-14">
          <div>
            ...
            <p className="mt-6 max-w-md text-base leading-8 text-zinc-700">
              Enter your order number or WhatsApp number to check your latest order status.
            </p>
            ...
            <Card className="mt-8 rounded-none border-zinc-200 shadow-none">
              <CardContent className="p-5 md:p-6">
                <form className="grid gap-4">
                  <div>
                    <label htmlFor="order" className="text-xs font-bold uppercase tracking-wide text-zinc-500">
                ...
                <div className="rounded-md bg-zinc-50 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-700">
                    If your order status is not updated yet, contact our customer care through WhatsApp.
                  </p>
                  <Button asChild variant="outline" className="mt-4 h-11 rounded-none border-black text-xs font-semibold uppercase tracking-wide hover:bg-black hover:text-white">
    ...
    <Card className="rounded-none border-zinc-200 shadow-none">
      <CardContent className="p-5 md:p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-wide text-zinc-500">Sample Result</p>
            <h2 className="mt-2 text-2xl font-black uppercase tracking-tight">{sampleOrder.orderNumber}</h2>
            <p className="mt-2 text-sm text-zinc-600">Customer: {sampleOrder.customerName}</p>
          </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <OrderMeta label="Tracking Number" value={sampleOrder.trackingNumber} />
          <OrderMeta label="Estimated Arrival" value={sampleOrder.estimatedArrival} />
        ...
        <div>
          <h3 className="text-sm font-black uppercase tracking-wide">Tracking Timeline</h3>
        ...
        <Button asChild variant="outline" className="mt-8 h-12 w-full rounded-none border-black text-xs font-semibold uppercase tracking-wide hover:bg-black hover:text-white">
          <Link href="https://wa.me/6281234567890">
            <MessageCircle className="mr-2 h-4 w-4" />
            Ask Customer Care
          </Link>
