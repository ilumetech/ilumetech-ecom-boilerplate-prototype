...
const steps = [
  {
    title: 'Browse & Choose',
    description: 'Explore our curated collections. Select your favorite items and pick the right size or variant from the product page.',
    icon: Search,
  },
  {
    title: 'Add to Cart',
    description: 'Click "Add to Cart" and review your selection. You can continue shopping to find more items or proceed directly to checkout.',
    icon: ShoppingBag,
  },
  {
    title: 'Shipping Details',
    description: 'Provide your delivery address and contact information accurately. Choose your preferred shipping method from the available options.',
    icon: UserCheck,
  },
  {
    title: 'Secure Payment',
    description: 'Complete your purchase using our secure payment gateway. We support various payment methods for your convenience.',
    icon: CreditCard,
  },
  {
    title: 'Order Tracking',
    description: 'Once confirmed, you will receive an order ID. You can track your shipment status in the "Track Order" page until it reaches you.',
    icon: Package,
  },
]
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          ...
          <div className="max-w-xl lg:justify-self-end">
            <p className="text-base leading-8 text-zinc-700">
              We&apos;ve simplified the shopping process so you can get your favorite products faster. Follow this quick guide to complete your first order at our official store.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="relative">
          ...
          <div className="space-y-16">
            {steps.map((step, index) => {
              ...
              return (
                <div key={step.title} className="relative flex flex-col gap-6 md:flex-row md:gap-12">
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-4 text-zinc-400">
                Explore our latest arrivals and experience a seamless shopping journey today.
              </p>
            </div>
            <div className="flex flex-col gap-4 sm:flex-row lg:justify-end">
              <Button asChild className="h-14 rounded-none bg-white px-10 text-xs font-bold uppercase tracking-widest text-black hover:bg-zinc-200">
                <Link href="/products">
                  Shop All Products
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 md:px-6 lg:py-14">
        <div className="grid overflow-hidden rounded-md border border-zinc-200 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center p-7 md:p-10">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-zinc-500">Need Assistance?</p>
            ...
            <p className="mt-4 max-w-md text-sm leading-7 text-zinc-700">
              Our customer support team is available to help you with any part of the ordering process, from choosing the right size to tracking your delivery.
            </p>
