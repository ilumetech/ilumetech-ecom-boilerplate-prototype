      ...
      <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <Input
                    id="first-name"
                    defaultValue="John"
                    className="h-12 rounded-none border-zinc-200 focus-visible:ring-0 focus-visible:border-black text-xs font-bold uppercase tracking-widest"
                  />
                </div>
                <div className="space-y-3">
                  <Label
        ...
        <div className="pt-12 border-t border-zinc-200">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            ...
            <Button
              variant="outline"
              className="rounded-none border-red-200 text-red-600 hover:bg-red-600 hover:text-white text-[10px] font-bold uppercase tracking-widest px-8"
            >
              Delete Account
            </Button>
          </div>
